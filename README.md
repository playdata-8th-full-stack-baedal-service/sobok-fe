...
<img src="./public/Sobokcookimg.png" alt="로고이미지" height="300">
...
| 사용자 메인페이지 | 라이더 메인페이지 | 
| :----------: | :----------: | 
| ![사용자 메인페이지](./public/mainpage.png) | ![라이더 메인페이지](./public/ridermain.png) | 
| **가게 메인페이지** | **관리자 메인페이지** |
| ![가게 메인페이지](./public/shopmain.png) | ![관리자 메인페이지](./public/adminmain.png) |
