...
const MainPage = () => {
  ...
  const navItems = [
    { path: '/rider/request-list', label: '배달 요청 조회', title: 'Dashboard', icon: (
    ...
    { path: '/rider/accepted-list', label: '수락한 요청 조회', title: 'Performance', icon: (
    ...
    { path: '/rider/history', label: '배달 기록 조회', title: 'Guides', icon: (
      <svg width="24" height="24" aria-hidden="true" fill="currentColor">
    ...
    { path: '/rider/info', label: '개인정보 조회', title: 'Segments', icon: (
      <svg width="24" height="24" aria-hidden="true" fill="currentColor">
      ...
      <nav className={`${styles.nav} ${!expanded ? styles.collapsed : ''}`} data-expanded={expanded}>
        <div className={styles.nav__main}>
          <div className={styles.nav__logo}>
            <svg role="img" aria-label="SOBOK 로고" width="24" height="24">
