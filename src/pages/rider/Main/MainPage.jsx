      ...
      <div className={styles.nav__main}>
        ...
        <ul className={styles.nav__items}>
          <li className={styles.nav__item}>
            <a className={styles.nav__item_box} href="#" title="Dashboard">
          ...
          <li className={styles.nav__item}>
            <a className={styles.nav__item_box} href="#" title="Performance">
              <span className={styles.nav__item_icon}>
                <svg width="24px" height="24px" aria-hidden="true">
          ...
          <li className={styles.nav__item}>
            <a className={styles.nav__item_box} href="#" title="Guides">
              <span className={styles.nav__item_icon}>
                <svg width="24px" height="24px" aria-hidden="true">
                  <g fill="currentColor">
          ...
          <li className={styles.nav__item}>
            <a className={`${styles.nav__item_box} ${styles.nav__item_box_red}`} href="#" title="Segments (24)">
